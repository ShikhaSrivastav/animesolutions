...
return(
    <div>
    {/* <div>
         <img src={img1} className="img1" alt='image 1'  />
        <img src={img2} className="img2" alt='image 2' />
        <img src={img3} className="img3" alt='image 3' />
        <img src={img4} className="img4"  alt='image 4' />
        <img src={img5} className="img5" alt='image 5' />
        <img src={img6} className="img6" alt='image 6' />
